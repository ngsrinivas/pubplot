...
def usage():
    ...
    print "--csv      Plot comma separated values"
...
def main():
    ...
    # get arguments
    try:
        options, real_args = getopt.gnu_getopt(
            args, "helbigx:y:t:f:o:k:p:a:",
            ["lx", "ly",  "csv", "xrange=", "yrange=", "bmargin=", "rmargin=",
             "lmargin=", "gopt=", "help", "small"])
    ...
    print "set style line 1 linewidth 6 pt 4 dt 1"
    print "set style line 2 linecolor rgb \"black\" linewidth 8 pt 6 dt 2"
    print "set style line 3 linewidth 8 pt 8 dt 5"
    print "set style line 4 linewidth 8 pt 5"
    print "set style line 5 linewidth 8 linecolor rgb \"brown\" pt 7"
    print "set style line 6 linewidth 8 linecolor rgb \"orange\" pt 7"
    print "set style line 7 linewidth 8 linecolor rgb \"#11FF11\" pt 7"
    print "set style line 8 linewidth 8 linecolor rgb \"violet\" pt 7"
